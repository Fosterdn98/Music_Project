...
public class Instructions {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        print("These are the instuctions for the game");
        print("Where there is a option please enter the number that is next to the choice and is surronded by breakets '[]'\n"
